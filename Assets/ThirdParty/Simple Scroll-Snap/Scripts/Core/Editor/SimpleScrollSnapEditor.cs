...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnapEditor : SSSCopyrightEditor
    {
        ...
        private SerializedProperty autoSetup, movementType, movementAxis, useAutomaticLayout, sizeControl, size, automaticLayoutSpacing, automaticLayoutMargins, useInfiniteScrolling, infiniteScrollingSpacing, useOcclusionCulling, startingPanel, useSwipeGestures, minimumSwipeSpeed, previousButton, nextButton, pagination, useToggleNavigation, snapTarget, snapSpeed, thresholdSpeedToSnap, useHardSnapping, useUnscaledTime, onTransitionEffects, onPanelSelecting, onPanelSelected, onPanelCentering, onPanelCentered;
        ...
        private void OnEnable()
        {
            ...
            autoSetup = serializedObject.FindProperty("autoSetup");
        ...
        private void ShowMovementAndLayoutSettings()
        {
            ...
            {
                EditorGUILayout.PropertyField(autoSetup);
                ShowStartingPanel();
                ShowMovementType();
            }
            EditorGUILayout.Space();
