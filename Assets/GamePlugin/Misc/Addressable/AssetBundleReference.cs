...
/// <summary>
    ...
    [Serializable]
    public class AssetBundleReferenceT<TObject> : AssetBundleReference where TObject : Object
    {
        /// <summary>
        /// Construct a new AssetReference object.
        /// </summary>
        /// <param name="guid">The guid of the asset.</param>
        public AssetBundleReferenceT(string guid)
            : base(guid)
        {
        }
    ...
    /// </summary>
    [Serializable]
    public class AssetBundleReferenceGameObject : AssetBundleReferenceT<GameObject>
    {
        /// <summary>
        /// Constructs a new reference to a GameObject.
        /// </summary>
        /// <param name="guid">The object guid.</param>
        public AssetBundleReferenceGameObject(string guid) : base(guid)
        {
        }
    }
    ...
    /// </summary>
    [Serializable]
    public class AssetBundleReferenceTexture : AssetBundleReferenceT<Texture>
    {
        /// <summary>
        /// Constructs a new reference to a Texture.
        /// </summary>
        /// <param name="guid">The object guid.</param>
        public AssetBundleReferenceTexture(string guid) : base(guid)
        {
        }
    }
    ...
    /// </summary>
    [Serializable]
    public class AssetBundleReferenceTexture2D : AssetBundleReferenceT<Texture2D>
    {
        /// <summary>
        /// Constructs a new reference to a Texture2D.
        /// </summary>
        /// <param name="guid">The object guid.</param>
        public AssetBundleReferenceTexture2D(string guid) : base(guid)
        {
        }
    }
    ...
    /// </summary>
    [Serializable]
    public class AssetBundleReferenceTexture3D : AssetBundleReferenceT<Texture3D>
    {
        /// <summary>
        /// Constructs a new reference to a Texture3D.
        /// </summary>
        /// <param name="guid">The object guid.</param>
        public AssetBundleReferenceTexture3D(string guid) : base(guid)
        {
        }
    }
    ...
    /// </summary>
    [Serializable]
    public class AssetBundleReferenceSprite : AssetBundleReferenceT<Sprite>
    {
        /// <summary>
        /// Constructs a new reference to a AssetBundleReferenceSprite.
        /// </summary>
        /// <param name="guid">The object guid.</param>
        public AssetBundleReferenceSprite(string guid) : base(guid)
        {
        }
    ...
    /// <summary>
    /// AssetBundleReference that only allows atlassed sprites.
    /// </summary>
    [Serializable]
    public class AssetBundleReferenceAtlasedSprite : AssetBundleReferenceT<Sprite>
    {
        /// <summary>
        /// Constructs a new reference to a AssetBundleReferenceAtlasedSprite.
        /// </summary>
        /// <param name="guid">The object guid.</param>
        public AssetBundleReferenceAtlasedSprite(string guid) : base(guid)
        {
        }
    ...
    /// </summary>
    [Serializable]
    public class AssetBundleReference : IKeyEvaluator
    {
        /// <summary>
        /// Asset GUID
        /// </summary>
...
#endif
        /// <summary>
        /// The AsyncOperationHandle currently being used by the AssetBundleReference.
        /// For example, if you call AssetBundleReference.LoadAssetAsync, this property will return a handle to that operation.
        /// </summary>
        ...
        static HashSet<AssetBundleReference> m_ActiveAssetReferences = new HashSet<AssetBundleReference>();
        ...
        static void EditorApplicationOnplayModeStateChanged(PlayModeStateChange state)
        {
            ...
            // {
            //     foreach (AssetBundleReference reference in m_ActiveAssetReferences)
            //     {
        ...
        /// <summary>
        /// Construct a new AssetBundleReference object.
        /// </summary>
        ...
        /// </summary>
        /// <param name="guid">The guid of the asset.</param>
        public AssetBundleReference(string guid)
        {
            m_AssetGUID = guid;
        }
        ...
        /// Load the referenced asset as type TObject.
        /// This cannot be used a second time until the first load is released. If you wish to call load multiple times
        /// on an AssetBundleReference, use <see cref="Addressables.LoadAssetAsync{TObject}(object)"/> and pass your AssetBundleReference in as the key.
        ///
        /// See the [Loading Addressable Assets](xref:addressables-api-load-asset-async) documentation for more details.
        /// </summary>
        ...
        /// This cannot be used a second time until the first load is released. If you wish to call load multiple times
        /// on an AssetBundleReference, use Addressables.LoadSceneAsync() and pass your AssetBundleReference in as the key.
        /// See the [Loading Addressable Assets](xref:addressables-api-load-asset-async) documentation for more details.
        /// </summary>
        ...
        /// This cannot be used a second time until the first load is released. If you wish to call load multiple times
        /// on an AssetBundleReference, use Addressables.InstantiateAsync() and pass your AssetBundleReference in as the key.
        /// See the [Loading Addressable Assets](xref:addressables-api-load-asset-async) documentation for more details.
        /// </summary>
        ...
        public virtual AsyncOperationHandle<TObject> LoadAssetAsync<TObject>()
        {
            ...
            if (m_Operation.IsValid())
                Debug.LogError("Attempting to load AssetBundleReference that has already been loaded. Handle is exposed through getter OperationHandle");
            else
            {
        ...
        public virtual AsyncOperationHandle<SceneInstance> LoadSceneAsync(LoadSceneMode loadMode = LoadSceneMode.Single, bool activateOnLoad = true, int priority = 100)
        {
            ...
            if (m_Operation.IsValid())
                Debug.LogError("Attempting to load AssetBundleReference Scene that has already been loaded. Handle is exposed through getter OperationHandle");
            else
            {
...
#pragma warning restore CS0414
        ...
        /// <summary>
        /// Sets the main asset on the AssetBundleReference.  Only valid in the editor, this sets both the editorAsset attribute,
        ...
        ///   the AssetBundleReference is set to a sprite within a sprite atlas, the editorAsset is the atlas (loaded during edit mode)
        ///   and the sub object is the sprite (loaded during runtime). If called by AssetBundleReferenceT, will set the editorAsset
        ...
        internal bool OnSetEditorAsset(Object value, Type derivedType)
        {
            ...
            if (CachedAsset != value)
            {
                ...
                {
                    Addressables.LogWarningFormat("Invalid object for AssetBundleReference {0}.", value);
                    return false;
                }

                if (!ValidateAsset(path))
                {
                    Addressables.LogWarningFormat("Invalid asset for AssetBundleReference path = '{0}'.", path);
                    return false;
                }
                else
                {
