...
[CustomEditor(typeof(AppsFlyerHelperScript))]
[CanEditMultipleObjects]
public class AppsFlyerHelperEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        GUILayout.Box((Texture)AssetDatabase.LoadAssetAtPath("Assets/Sdk/AppFlyerHelper/Editor/logo.png", typeof(Texture)), new GUILayoutOption[] { GUILayout.Width(600) });
