...
{
    public class AdsMyTargetBridge : MonoBehaviour
    {
        ...
        private AdsMyTargetIF adsMyTargetIF;

        public static AdsMyTargetBridge Instance { get; private set; }
        ...
        private void Awake()
        {
            ...
            {
                Instance = this;
                gameObject.name = "AdsMyTargetBridge";
#if ENABLE_ADS_MYTARGET && !UNITY_EDITOR
#if UNITY_ANDROID
                adsMyTargetIF = new AdsMyTargetAndroid();
#else
                adsMyTargetIF = new AdsMyTargetiOS();
#endif
#endif
            }
            else
...
#region IAdsMyTargetIFClient implementation
        public void Initialize()
        {
#if ENABLE_ADS_MYTARGET && !UNITY_EDITOR
            adsMyTargetIF.Initialize();
#endif
        }
        public void addTestDevice(string deviceId)
        {
#if ENABLE_ADS_MYTARGET && !UNITY_EDITOR
            adsMyTargetIF.addTestDevice(deviceId);
#endif
        }
        public void setTestMode(bool isTestMode)
        {
#if ENABLE_ADS_MYTARGET && !UNITY_EDITOR
            adsMyTargetIF.setTestMode(isTestMode);
#endif
        }
        public void setBannerPos(int pos, int width, float dxCenter)
        {
#if ENABLE_ADS_MYTARGET && !UNITY_EDITOR
            adsMyTargetIF.setBannerPos(pos, width, dxCenter);
#endif
        }
        public void showBanner(string adsId, int pos, int width, int orien, bool iPad, float dxCenter)
        {
#if ENABLE_ADS_MYTARGET && !UNITY_EDITOR
            adsMyTargetIF.showBanner(adsId, pos, width, orien, iPad, dxCenter);
#endif
        }
        public void hideBanner()
        {
#if ENABLE_ADS_MYTARGET && !UNITY_EDITOR
            adsMyTargetIF.hideBanner();
#endif
        }
        ...
        {
#if ENABLE_ADS_MYTARGET && !UNITY_EDITOR
            adsMyTargetIF.loadFull(adsId);
#endif
        }
        public bool showFull()
        {
#if ENABLE_ADS_MYTARGET && !UNITY_EDITOR
             return adsMyTargetIF.showFull(); 
#else
            return false;
#endif
        }
        ...
        {
#if ENABLE_ADS_MYTARGET && !UNITY_EDITOR
            adsMyTargetIF.loadGift(adsId); 
#endif
        }
        public bool showGift()
        {
#if ENABLE_ADS_MYTARGET && !UNITY_EDITOR
            return adsMyTargetIF.showGift(); 
#else
            return false;
#endif
        }
