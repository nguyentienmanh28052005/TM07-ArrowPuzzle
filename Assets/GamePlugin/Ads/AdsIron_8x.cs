    ...
    partial class AdsIron
    {
        ...
        private void irOnImpressionDataReadyEvent(IronSourceImpressionData impressionData)
        {
            if (impressionData != null)
            {
                ...
                TiktokBusiness.logAdRevenueIron(impressionData.auctionId, impressionData.adFormat, impressionData.adNetwork, impressionData.instanceName, impressionData.instanceId, impressionData.country, impressionData.placement, rvalue, impressionData.precision, impressionData.ab, impressionData.segmentName, lva, impressionData.encryptedCPM, impressionData.CreativeId);
            }
        }
