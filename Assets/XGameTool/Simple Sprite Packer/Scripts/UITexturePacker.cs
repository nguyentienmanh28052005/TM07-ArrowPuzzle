...
public class SPUITexturePacker
{
    ...
    public SPUITexturePacker(int width, int height, bool rotations)
    {
    ...
    public static Rect[] PackTextures(Texture2D texture, Texture2D[] textures, int width, int height, int padding, int maxSize)
    {
        ...
        SPUITexturePacker bp = new SPUITexturePacker(width, height, false);
