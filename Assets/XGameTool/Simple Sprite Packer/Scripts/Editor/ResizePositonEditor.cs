...
namespace SimpleSpritePackerEditor
{
    public class ResizePositonEditor : EditorWindow
    {
        ...
        public bool m_UseUnitySize = false;
        ...
        private void OnGUI()
        {
            try
            {
                ...
                m_UseUnitySize = GUILayout.Toggle(m_UseUnitySize, "is Use Unity Size");
                if (!m_IsAuto)
                {
            ...
            else
            {
                ...
                if (GUILayout.Button("Replace"))
                {
                    ...
                    {
                        m_AtlasBuilder.ResizeTexture(m_Textures[i], m_IsAuto, m_UseUnitySize, m_Direction);
                    }

                    EditorUtility.DisplayDialog("Resize Texture", "Resize Texture succes", "Okay");
        ...
        [MenuItem("Window/Simple Sprite Packer/ResizeTexture")]
