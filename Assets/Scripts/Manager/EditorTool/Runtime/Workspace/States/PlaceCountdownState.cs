...
public class PlaceCountdownState : EditorStateBase
{
    public PlaceCountdownState(LevelEditorWorkspace editor) : base(editor) {}

    public override void HandleMouseDown(Vector2Int gridPos)
    {
        if (editor.IsPositionOccupied(gridPos) || editor.countdownBlockPrefab == null) return;
        ...
        GameObject obj = editor.Spawn(editor.countdownBlockPrefab, new Vector3(gridPos.x, gridPos.y, 0), Quaternion.identity, editor.levelContainer);
