...
public static class PlaytestSession
{
    ...
    public static LevelDataV2 LevelData;
    ...
    public static LevelDataV2 GetActiveLevelData()
    {
    ...
    private static void RestoreQueuedEditorPlaytest()
    {
        ...
        LevelDataV2 levelData = AssetDatabase.LoadAssetAtPath<LevelDataV2>(levelPath);
