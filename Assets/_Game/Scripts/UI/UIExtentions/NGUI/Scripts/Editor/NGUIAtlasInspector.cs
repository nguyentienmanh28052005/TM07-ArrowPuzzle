...
public class NGUIAtlasInspector : Editor
{
	...
	void OnEnable()
	{
		...
		NGUISettings.selectedSpriteChange = Repaint;
	}
	...
	public override void OnInspectorGUI ()
	{
		...
		//GUILayout.Space(6f);
		Texture mat = EditorGUILayout.ObjectField("Texture", mAtlas.texture, typeof(Texture), false) as Texture;

		if (mAtlas.texture != mat)
		{
			NGUIEditorTools.RegisterUndo("Atlas Change", mAtlas as Object);
			mAtlas.texture = mat;

			// Ensure that this atlas has valid import settings
			if (mAtlas.texture != null) NGUIEditorTools.ImportTexture(mAtlas.texture, false, false, true);
