...
[CustomEditor( typeof( UISlideImage ) ), CanEditMultipleObjects]
public class UISlideImageEditor : Editor
{
...
[AddComponentMenu( "UI/UISlideImage", 11 )]
public class UISlideImage : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
{
...
#pragma warning restore 1692
...
#if UNITY_2017_4 || UNITY_2018_2_OR_NEWER
	private static List<UISlideImage> m_TrackedTexturelessImages = new List<UISlideImage>();
	...
	private static void RebuildImage( SpriteAtlas spriteAtlas )
	{
		...
		{
			UISlideImage image = m_TrackedTexturelessImages[i];
